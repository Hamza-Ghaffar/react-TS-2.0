    ...
    return (
        <div className="px-16 md-mx:px-8 sm-mx:px-4 mx-20 lg-mx:mx-10 md-mx:mx-0 my-10 font-mono" id="Contact">
            ...
            <div
                ...
                className="w-[70%] lg-mx:w-full shadow-[0_0_10px_0_#64FFDA50] m-auto flex flex-col gap-6 border border-red-600 p-8 rounded-3xl sm-mx:p-4"
                style={{ backgroundColor: '#0a192f' }} // Updated background color
            >
                <div className="text-3xl flex gap-2 items-center text-white font-semibold sm-mx:text-2xl xs-mx:text-xl">
                    Let's Connect
                    <IconTopologyStar3 className="w-10 text-red-600 h-10 sm-mx:w-7 sm-mx:h-7" />
                </div>
                ...
                <Button
                    ...
                    size={btn}
                    radius="lg"
                    color="teal" // Matching accent color
                    style={{ backgroundColor: '#ffff', color: '#0a192f' }} // Updated button color
                >
                    Send
                </Button>
            </div>
